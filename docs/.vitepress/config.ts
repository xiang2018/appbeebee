...
export default defineConfig<ThemeConfig>({
    ...
    base: '/',
    head,
    description: 'spring，java，python',
    ignoreDeadLinks: true,
    themeConfig: {
        beecodeurl: '/', //这里是内页ArticleLink组件用到的跳转第三方网址，一般用不到，仅仅用于二次开发
        ...
        socialLinks: [
            ...
            //     }, link: 'https://mp.weixin.qq.com/s/TDtZuwuYhrxjWoNGNWTbQQ',
            //     ariaLabel: 'red'
            // },
            // {
            //     icon: {
        ...
        website: {
            ...
            cardMusic: false, //是否显示播放音乐，音乐列表在上面 music中配置
